...
ISpeechXMLRecoResult._methods_ = [
    COMMETHOD([dispid(10), helpstring('GetXMLResult')], HRESULT, 'GetXMLResult',
              ...
              ( ['retval', 'out'], POINTER(BSTR), 'pResult' )),
...
##    def GetXMLErrorInfo(self, pSemanticErrorInfo):
##        '-no docstring-'
##        #return 
##
##    def GetXMLResult(self, Options):
...
ISpRecognizer2._methods_ = [
    ...
    COMMETHOD([], HRESULT, 'SetTrainingState',
              ( [], c_int, 'fDoingTraining' ),
              ( [], c_int, 'fAdaptFromTrainingData' )),
...
__all__ = [ 'DISPID_SVVolume',
           'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
           'DISPID_SpeechGrammarRule', 'SP_VISEME_7',
           'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
           'WaveFormatEx', 'ISpeechPhraseReplacement',
           'SAFTCCITT_ALaw_11kHzStereo', 'SpNotifyTranslator',
           'SRTAutopause', 'DISPID_SRCEPropertyNumberChange',
           'DISPID_SpeechVoiceStatus', 'SPSMF_SAPI_PROPERTIES',
           'DISPID_SPIRetainedSizeBytes',
           'ISpeechLexiconPronunciations',
           'DISPID_SRSCurrentStreamPosition', 'SPAS_PAUSE',
           'DISPID_SRGDictationSetState', 'SP_VISEME_14',
           'SP_VISEME_17', 'ISpAudio', 'SPINTERFERENCE_TOOSLOW',
           'SDTAudio', 'DISPID_SPEEngineConfidence',
           'SAFT22kHz8BitMono', 'SpeechRegistryLocalMachineRoot',
           'SPSNoun', 'ISpeechObjectTokenCategory',
           'DISPID_SVAlertBoundary', 'DISPID_SGRSAddRuleTransition',
           'SPDKL_CurrentConfig', 'SREPropertyStringChange',
           'SAFT8kHz16BitMono', 'DISPID_SRRPhraseInfo',
           'SPEI_REQUEST_UI', 'ISpeechRecognizerStatus',
           'SVESentenceBoundary', 'IEnumSpObjectTokens', 'SVP_10',
           'SVEPhoneme', 'SVP_5', 'ISpRecoGrammar2',
           'DISPID_SRGCmdLoadFromFile', 'DISPID_SVSkip',
           'DISPID_SRCRecognizer', 'DISPID_SGRSTPropertyName',
           'SPPS_Unknown', 'SPCS_ENABLED', 'DISPID_SPAPhraseInfo',
           'DISPID_SLGenerationId', 'ISpResourceManager',
           'DISPID_SRCVoice', 'SpeechRecoContextState', 'SPFILEMODE',
           'SPINTERFERENCE_TOOLOUD', 'SFTInput',
           'ISpeechGrammarRuleStateTransitions', 'DISPID_SOTCategory',
           'ISpNotifyTranslator', 'DISPID_SVSInputSentenceLength',
           'DISPID_SPISaveToMemory', 'ISpeechPhoneConverter',
           'DISPID_SpeechPhraseElement', 'ISpEventSink',
           'DISPID_SLWType', 'DISPIDSPTSI_ActiveLength',
           'SECFIgnoreCase', 'SVP_4', 'SPEI_PROPERTY_STRING_CHANGE',
           'SpeechVoicePriority', 'SPSEMANTICFORMAT', 'SP_VISEME_20',
           'SPEI_PHRASE_START', 'DISPID_SPIProperties',
           'eLEXTYPE_PRIVATE3', 'DISPID_SDKEnumValues',
           'ISpeechLexiconWords', 'DISPID_SOTsCount', 'SVSFDefault',
           'DISPID_SVSpeakStream', 'DISPIDSPTSI_ActiveOffset',
           'DISPID_SRRSaveToMemory', 'SPCT_COMMAND',
           'DISPID_SpeechDataKey', '__MIDL_IWinTypes_0009',
           'DISPID_SRCEAdaptation', 'DISPID_SBSWrite',
           'SPEVENTSOURCEINFO', 'DISPID_SpeechVoiceEvent',
           'ISpeechPhraseProperties', 'DISPID_SpeechRecoResultTimes',
           'SpeechRecognitionType', 'ISpPhoneConverter',
           'ISpeechVoiceStatus', 'SDTLexicalForm', 'SVP_16',
           'DISPID_SVEEnginePrivate', 'SpeechStreamFileMode',
           'DISPID_SPEAudioSizeBytes',
           'SpeechPropertyHighConfidenceThreshold',
           'SpeechRecognizerState', 'DISPID_SVESentenceBoundary',
           'DISPID_SPCIdToPhone', 'SPSSuppressWord',
           'SpeechBookmarkOptions', 'ISpeechPhraseProperty',
           'IEnumString', 'ISpEventSource', 'SAFT24kHz16BitMono',
           'DISPID_SpeechPhraseProperties', 'DISPID_SRProfile',
           'DISPID_SVEStreamStart', 'SPRECORESULTTIMES',
           'SVEVoiceChange', 'SPEI_START_INPUT_STREAM',
           'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'ISpeechRecoGrammar',
           'eLEXTYPE_RESERVED9',
           'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
           'DISPID_SGRSAddSpecialTransition', 'SAFT12kHz16BitStereo',
           'eLEXTYPE_PRIVATE12', 'Speech_StreamPos_Asap',
           'SPGS_EXCLUSIVE', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SGRsAdd',
           'ISpRecognizer3', 'SpeechDiscardType',
           'SPXRO_Alternates_SML', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
           'eLEXTYPE_LETTERTOSOUND', 'SAFTADPCM_8kHzStereo',
           'DISPID_SRCRetainedAudio', 'SASPause',
           'SVEStartInputStream', 'SRATopLevel', 'SRAORetainAudio',
           'ISpProperties', 'ISpeechPhraseReplacements',
           'DISPID_SLGetGenerationChange', 'DISPID_SLPPartOfSpeech',
           'DISPID_SRCreateRecoContext', 'SDKLDefaultLocation',
           'DISPID_SRGDictationLoad', 'SGSDisabled',
           'DISPID_SAFSetWaveFormatEx', 'SAFTCCITT_uLaw_8kHzStereo',
           'SpeechVisemeFeature', 'DISPID_SPAStartElementInResult',
           'eLEXTYPE_RESERVED6', 'ISpeechGrammarRuleState',
           'SAFT48kHz8BitStereo', 'SP_VISEME_6',
           'SPWORDPRONUNCIATIONLIST', 'SAFTADPCM_22kHzMono', 'SVP_18',
           'SAFTCCITT_uLaw_44kHzStereo',
           'DISPIDSPTSI_SelectionOffset', 'SDTPronunciation',
           'SREPhraseStart', 'ISpeechPhraseInfo',
           'SDA_Consume_Leading_Spaces', 'DISPID_SPRulesItem',
           'eWORDTYPE_DELETED', 'SpeechSpecialTransitionType',
           'DISPID_SpeechRecoResult', 'SpeechAudioVolume',
           'SPFM_CREATE', 'SpeechTokenIdUserLexicon',
           'DISPID_SWFEFormatTag', 'DISPID_SpeechRecoContext',
           'DISPID_SPIEngineId', 'ISpRecoCategory',
           'DISPID_SPAsCount', 'DISPID_SpeechPhraseReplacements',
           'ISpeechRecognizer', 'DISPID_SVSPhonemeId',
           'DISPID_SRGetRecognizers',
           'DISPID_SVSInputSentencePosition', 'DISPID_SRCEHypothesis',
           'SPEI_ACTIVE_CATEGORY_CHANGED',
           'DISPID_SpeechPhoneConverter', 'SPAUDIOOPTIONS',
           'DISPID_SpeechLexiconProns', 'SPSInterjection',
           'ISequentialStream', 'DISPID_SVEPhoneme', 'SAFTText',
           'SREFalseRecognition', 'DISPID_SVWaitUntilDone',
           'SPEI_RESERVED1', 'DISPID_SVStatus',
           'SPINTERFERENCE_TOOQUIET', 'SLOStatic', 'SFTSREngine',
           'DISPID_SLWs_NewEnum', 'DISPID_SVEViseme',
           'DISPID_SVSLastResult', 'SPPHRASEREPLACEMENT',
           'DISPID_SABufferNotifySize', 'SAFTNoAssignedFormat',
           'SPEI_VISEME', 'DISPID_SRCRequestedUIType',
           'SGLexicalNoSpecialChars', 'DISPID_SPEAudioSizeTime',
           'SPBO_PAUSE', 'SAFT32kHz8BitMono', 'ISpeechAudioFormat',
           'SpeechRuleAttributes', 'DISPID_SpeechPhraseBuilder',
           'SPLOADOPTIONS', 'DISPID_SRRTStreamTime',
           'DISPID_SPCPhoneToId', 'SRAInterpreter', 'DISPID_SGRId',
           'DISPID_SRCEAudioLevel', 'DISPID_SFSClose',
           'Speech_StreamPos_RealTime',
           'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPCT_SUB_COMMAND',
           'ISpVoice', 'ISpeechLexicon', 'DISPID_SLWPronunciations',
           'SVSFIsNotXML', 'ISpeechMemoryStream',
           'SGDSActiveWithAutoPause', 'SpeechPropertyResponseSpeed',
           'DISPID_SpeechBaseStream', 'SPFM_CREATE_ALWAYS',
           'DISPID_SPELexicalForm', 'DISPID_SPRuleEngineConfidence',
           'SpeechAudioFormatGUIDText', 'eLEXTYPE_PRIVATE2',
           'DISPID_SDKDeleteValue', 'SREPrivate', 'SVPNormal',
           'SPGS_ENABLED', 'DISPID_SPRuleId', 'DISPID_SBSRead',
           'SpMMAudioIn', 'SAFTGSM610_8kHzMono',
           'SAFTCCITT_ALaw_11kHzMono', 'SVEAllEvents',
           'DISPID_SOTGetStorageFileName', 'SpFileStream',
           '_SPAUDIOSTATE', 'DISPID_SRCEventInterests',
           'SPEI_TTS_AUDIO_LEVEL',
           'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SVP_1',
           'eLEXTYPE_PRIVATE17', 'SGDSInactive',
           'DISPID_SCSBaseStream', 'DISPID_SVResume',
           'DISPID_SpeechObjectTokens', 'SpNullPhoneConverter',
           'DISPID_SVGetVoices', 'SpeechCategoryAppLexicons',
           'SpResourceManager', 'DISPID_SVSpeakCompleteEvent',
           'SPSModifier', 'SPGRAMMARWORDTYPE',
           'DISPID_SRGSetWordSequenceData',
           'IInternetSecurityMgrSite', 'SPPHRASEELEMENT',
           'SPWT_LEXICAL', 'SREAllEvents', 'SREAdaptation',
           'DISPID_SOTCEnumerateTokens', 'DISPID_SRCEEnginePrivate',
           'DISPID_SPAs_NewEnum', 'SPSUnknown',
           'SAFTNonStandardFormat', 'DISPID_SRCCmdMaxAlternates',
           'DISPID_SPPId', 'ISpeechLexiconWord', 'SPAR_High',
           'SPSEMANTICERRORINFO', 'SPRST_NUM_STATES',
           'SAFTADPCM_44kHzStereo', 'ISpeechGrammarRules',
           'SpObjectTokenCategory', 'DISPID_SPPNumberOfElements',
           'SPSMF_UPS', 'SpPhoneConverter',
           'DISPID_SpeechLexiconWords',
           'ISpPhoneticAlphabetConverter', 'DISPID_SGRSTWeight',
           'DISPID_SpeechMemoryStream', 'DISPID_SOTGetDescription',
           'SPEI_WORD_BOUNDARY', 'SPFM_NUM_MODES',
           'SPEI_SR_RETAINEDAUDIO', 'SBONone', 'DISPID_SRRAlternates',
           'SRARoot', 'SVSFParseSapi', 'DISPID_SLRemovePronunciation',
           'SVP_7', 'SP_VISEME_13', 'SPINTERFERENCE_NONE',
           'SpeechPropertyResourceUsage',
           'DISPID_SpeechRecoContextEvents', 'SpSharedRecoContext',
           'DISPID_SRRAudioFormat', 'DISPID_SVGetAudioInputs',
           'SpeechAllElements', 'SPDKL_LocalMachine',
           'DISPID_SWFEExtraData', 'DISPID_SRGCmdLoadFromMemory',
           'ISpObjectToken', 'SpeechAudioFormatType',
           'ISpeechBaseStream', 'DISPID_SPRFirstElement',
           'DISPID_SDKSetBinaryValue', 'SPEI_START_SR_STREAM',
           'DISPID_SVSInputWordLength', 'SPBINARYGRAMMAR',
           'DISPID_SGRSTRule', 'STSF_LocalAppData',
           'SpeechInterference', 'SSTTDictation',
           'SpeechGrammarTagWildcard', 'DISPID_SGRClear',
           'SPEI_END_INPUT_STREAM', 'tagSPPROPERTYINFO',
           'SPLO_STATIC', 'SVSFNLPMask', 'SECHighConfidence',
           'DISPID_SPIGetDisplayAttributes', 'DISPID_SAFType',
           'DISPID_SWFEBlockAlign',
           'DISPID_SpeechGrammarRuleStateTransition',
           'DISPID_SPIElements', 'SPEI_SOUND_END',
           'SAFT12kHz8BitStereo', 'ISpStream', 'SAFT22kHz16BitMono',
           'DISPID_SPIStartTime',
           'DISPID_SRCERecognitionForOtherContext',
           'DISPID_SpeechRecognizerStatus', 'SPPS_RESERVED4',
           'DISPID_SRGId', 'SRAONone', 'SPEVENT',
           'SAFT22kHz16BitStereo', 'DISPID_SRSCurrentStreamNumber',
           'SPINTERFERENCE_NOSIGNAL', 'SP_VISEME_2',
           'DISPID_SPIAudioSizeBytes',
           'DISPID_SRCCreateResultFromMemory',
           'DISPID_SOTRemoveStorageFileName',
           'SpeechVoiceCategoryTTSRate', 'ISpRecoResult',
           'SPVOICESTATUS', 'SPSHORTCUTTYPE', 'SPAR_Low', 'SPWORD',
           'SWPUnknownWordPronounceable', 'SpCompressedLexicon',
           'DISPID_SAStatus', 'SAFTCCITT_ALaw_44kHzMono',
           'ISpeechPhraseElement', 'DISPID_SVEBookmark',
           'DISPID_SOTCGetDataKey', 'DISPID_SPEs_NewEnum', 'SBOPause',
           'DISPID_SADefaultFormat', 'DISPID_SGRsCommitAndSave',
           'DISPID_SpeechGrammarRules', 'SPSHT_EMAIL',
           'DISPID_SVGetAudioOutputs', 'DISPID_SRSSupportedLanguages',
           'SpeechFormatType', 'SECFDefault', 'SRTEmulated',
           'SpeechDataKeyLocation', 'DISPID_SGRSTs_NewEnum',
           'SPAUDIOBUFFERINFO', 'SpeechRegistryUserRoot',
           'DISPID_SRRGetXMLResult', 'SAFT48kHz16BitStereo',
           'eLEXTYPE_PRIVATE20', 'SPVPRIORITY', 'SASRun',
           'eLEXTYPE_PRIVATE14', 'DISPID_SOTSetId', 'SPGS_DISABLED',
           'SPINTERFERENCE', 'SpAudioFormat',
           'DISPID_SRCRetainedAudioFormat', 'SGRSTTDictation',
           'SAFT48kHz8BitMono', 'SPBOOKMARKOPTIONS',
           'DISPID_SVGetProfiles', 'DISPID_SMSSetData',
           'SDA_One_Trailing_Space', 'SVP_9', 'SP_VISEME_3',
           'SPADAPTATIONRELEVANCE',
           'DISPID_SRCERecognizerStateChange', 'DISPID_SGRsItem',
           'SPXRO_SML', 'DISPID_SpeechPhraseAlternates',
           'DISPID_SGRsFindRule', 'DISPID_SPIRule',
           'SpStreamFormatConverter',
           'SpeechPropertyComplexResponseSpeed', 'DISPID_SVDisplayUI',
           'SVSFParseSsml', 'DISPID_SASetState',
           'DISPID_SASFreeBufferSpace', 'DISPID_SVSpeak',
           'DISPID_SRRSpeakAudio', 'DISPID_SRGetFormat',
           'DISPID_SRCESoundEnd', 'SWPUnknownWordUnpronounceable',
           'SASClosed', 'SDTReplacement', 'SpeechWordType',
           'DISPID_SRDisplayUI', 'SAFTGSM610_11kHzMono',
           'SREPropertyNumChange', 'SpeechRetainedAudioOptions',
           'DISPID_SRGCmdSetRuleState', 'SPSLMA',
           'SpeechPartOfSpeech', 'DISPID_SLGetPronunciations',
           'DISPID_SRGCmdLoadFromObject', 'SPPS_Function',
           'SPSTREAMFORMATTYPE', 'SAFT12kHz16BitMono', 'SINone',
           'SGDisplay', 'DISPID_SPRNumberOfElements',
           'eLEXTYPE_PRIVATE19', 'SpStream', 'SpeechTokenValueCLSID',
           'DISPID_SRAudioInputStream', 'SVP_15', 'SPAR_Unknown',
           'DISPID_SFSOpen', 'eLEXTYPE_PRIVATE9',
           'DISPID_SRRGetXMLErrorInfo', 'SVP_8', 'SSFMCreateForWrite',
           'DISPID_SPEsCount', 'DISPID_SPRulesCount',
           'DISPID_SPPName', 'SpeechCategoryPhoneConverters',
           'DISPID_SRGIsPronounceable', 'SGDSActive',
           'DISPID_SGRSTText', 'eLEXTYPE_PRIVATE18',
           'eWORDTYPE_ADDED', 'SVP_6', 'eLEXTYPE_PRIVATE10',
           'SPINTERFERENCE_TOOFAST', 'SP_VISEME_1',
           'SAFT32kHz16BitStereo', 'SPGRAMMARSTATE', 'SPVISEMES',
           'SAFT24kHz8BitMono', 'SP_VISEME_15', 'ISpeechCustomStream',
           'STCLocalServer', 'SP_VISEME_4', 'ISpeechRecoResult2',
           'SpLexicon', 'SRESoundStart', 'SAFT11kHz8BitMono',
           'eLEXTYPE_VENDORLEXICON', 'DISPID_SDKEnumKeys',
           'SPPS_NotOverriden', 'SPPS_SuppressWord',
           'DISPID_SLPPhoneIds', 'DISPID_SGRName', 'SpShortcut',
           'DISPID_SLPSymbolic', 'DISPID_SRGCommit',
           'DISPID_SRCERequestUI', 'SPLO_DYNAMIC',
           'eLEXTYPE_RESERVED4', 'SPFM_OPEN_READWRITE',
           'ISpMMSysAudio', 'SREBookmark', 'DISPID_SMSGetData',
           'DISPID_SVSCurrentStreamNumber', 'SGLexical', 'SITooSlow',
           'SPSHT_OTHER', 'SPAUDIOSTATUS', 'SDTAll',
           'SGDSActiveUserDelimited', 'SPTEXTSELECTIONINFO',
           'SDKLCurrentConfig', 'SGRSTTRule',
           'DISPID_SASNonBlockingIO', 'SpeechLexiconType', 'SRSEDone',
           'DISPID_SpeechRecognizer', 'DISPID_SRSetPropertyNumber',
           'SDTAlternates', 'SECFIgnoreWidth', 'SPEI_HYPOTHESIS',
           'DISPID_SOTCreateInstance', 'DISPIDSPTSI_SelectionLength',
           'ISpeechFileStream', 'DISPID_SRGetPropertyNumber',
           'DISPID_SpeechAudio', 'SECLowConfidence', 'SVPOver',
           'DISPID_SRRDiscardResultInfo', 'SPRULESTATE',
           'SpeechVoiceEvents', 'SREStreamStart', 'SPVPRI_NORMAL',
           'DISPID_SPACommit', 'DISPID_SGRSTType', 'SPPHRASERULE',
           'STSF_AppData', 'ISpeechPhraseAlternate',
           'DISPID_SpeechPhraseInfo', 'SPEI_TTS_BOOKMARK',
           'DISPID_SRCAudioInInterferenceStatus',
           'SpeechCategoryAudioOut', 'DISPID_SpeechPhraseAlternate',
           'SAFTCCITT_uLaw_22kHzStereo',
           'SpeechPropertyNormalConfidenceThreshold',
           'SRSInactiveWithPurge', 'eLEXTYPE_PRIVATE5',
           'SRERequestUI', 'STCRemoteServer', 'SPPS_RESERVED2',
           'SpeechGrammarTagUnlimitedDictation', 'eLEXTYPE_PRIVATE6',
           'DISPID_SLRemovePronunciationByPhoneIds',
           'DISPID_SOTMatchesAttributes',
           'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechRecoResult',
           'SSFMOpenForRead', 'SAFT8kHz8BitStereo',
           'ISpXMLRecoResult', 'SpMMAudioOut', 'SPSFunction',
           'DISPID_SpeechPhraseRule', 'SPDKL_DefaultLocation',
           'SVP_2', 'DISPID_SRCState', 'SDTDisplayText', 'SPWF_INPUT',
           'DISPID_SDKDeleteKey', 'SPPS_Noncontent',
           'ISpRecoContext2', 'SPEI_RESERVED6', 'ISpPhraseAlt',
           'DISPID_SPPConfidence', 'SpeechRecoProfileProperties',
           'SWTAdded', 'tagSPTEXTSELECTIONINFO', 'DISPID_SRCPause',
           'DISPID_SPERequiredConfidence', 'DISPID_SLWsCount',
           'SPAO_RETAIN_AUDIO', 'SpPhraseInfoBuilder',
           'DISPID_SPANumberOfElementsInResult',
           'DISPID_SVAudioOutputStream', 'SpeechVoiceSpeakFlags',
           'DISPID_SMSADeviceId', 'SPEI_RECO_STATE_CHANGE',
           'DISPID_SPIGrammarId', 'DISPID_SPIEnginePrivateData',
           'DISPID_SOTRemove', 'SPEI_VOICE_CHANGE', 'SPSHORTCUTPAIR',
           'DISPID_SLWLangId', 'SPEI_RESERVED5', 'DISPID_SVSVisemeId',
           'ISpeechPhraseElements', 'DISPID_SVEWord',
           'ISpNotifySource', 'STCInprocHandler',
           'DISPID_SWFEBitsPerSample', 'DISPID_SPIReplacements',
           'DISPID_SPPEngineConfidence', 'SP_VISEME_10',
           'SpeechGrammarState', 'SREHypothesis', 'SPPROPERTYINFO',
           'DISPID_SRCEPhraseStart', 'SPSMF_SRGS_SAPIPROPERTIES',
           'DISPID_SPPsCount', 'ISpeechObjectTokens',
           'DISPID_SOTDataKey', 'DISPID_SWFESamplesPerSec',
           'SAFT11kHz16BitMono', 'SPPS_LMA', 'SVP_14',
           'DISPID_SVIsUISupported', 'SVSFlagsAsync',
           'DISPID_SPEAudioStreamOffset', 'DISPID_SpeechWaveFormatEx',
           'SP_VISEME_18', 'SRERecoOtherContext', 'SVEAudioLevel',
           'DISPID_SABIMinNotification', 'DISPID_SOTs_NewEnum',
           'SAFTCCITT_ALaw_8kHzStereo', 'Speech_Default_Weight',
           'ISpStreamFormat', 'DISPID_SRSAudioStatus', 'SPAS_CLOSED',
           'DISPID_SASCurrentDevicePosition',
           'DISPID_SVSLastBookmark', 'SPAUDIOSTATE', 'SPBO_NONE',
           'DISPID_SOTGetAttribute', 'SPRECOGNIZERSTATUS',
           'DISPID_SRCERecognition', 'DISPID_SOTCId', 'SITooLoud',
           'tagSTATSTG', 'DISPID_SVEventInterests',
           'ISpObjectWithToken', 'SpSharedRecognizer',
           'SPSHT_Unknown', 'SpeechEngineProperties',
           'SpeechCategoryRecognizers', 'SPAS_STOP',
           'eLEXTYPE_RESERVED8', 'DISPID_SPERetainedSizeBytes',
           'SSFMCreate', 'SpeechRunState', 'SVSFNLPSpeakPunc',
           'SLODynamic', 'SASStop', 'SAFTCCITT_uLaw_11kHzStereo',
           'SVP_0', 'SAFT16kHz16BitMono',
           'DISPID_SpeechLexiconPronunciation', 'SLTUser',
           'DISPID_SPPChildren', 'SPAS_RUN',
           'DISPID_SpeechAudioStatus', 'DISPID_SGRAttributes',
           'DISPID_SOTId', 'SRTReSent', 'SPSERIALIZEDRESULT',
           'SPRS_INACTIVE', 'DISPID_SPCLangId', 'DISPID_SGRSTsItem',
           'ISpNotifySink', 'ISpDataKey', 'eLEXTYPE_PRIVATE1',
           'SVPAlert', 'SVP_20', 'SGSExclusive',
           'SAFT44kHz16BitStereo', 'eLEXTYPE_PRIVATE7',
           'DISPID_SLAddPronunciationByPhoneIds', 'SPEI_UNDEFINED',
           'DISPID_SOTIsUISupported', 'SAFT16kHz16BitStereo',
           'SRAExport', 'SP_VISEME_12', 'DISPID_SLWWord',
           'DISPID_SpeechPhraseProperty', 'SVF_Stressed',
           'DISPID_SPRuleParent', 'DISPID_SLPLangId',
           'DISPID_SVEAudioLevel', 'SpeechAddRemoveWord',
           'SPEI_SOUND_START', 'DISPID_SPEsItem',
           'DISPID_SRCSetAdaptationData',
           'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPPFirstElement',
           'SPEI_MIN_TTS', 'DISPID_SGRsDynamic',
           'SAFTExtendedAudioFormat', 'SAFTADPCM_44kHzMono',
           'eLEXTYPE_PRIVATE11', 'SGRSTTWord', 'DISPID_SRIsShared',
           'SpeechTokenKeyAttributes', 'DISPID_SRGetPropertyString',
           'DISPID_SDKGetBinaryValue', 'DISPID_SGRAddState',
           'SPSHT_NotOverriden', 'SpeechUserTraining',
           'ISpObjectTokenCategory', 'ISpeechAudioBufferInfo',
           'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
           'SECFEmulateResult', 'SpeechVoiceSkipTypeSentence',
           'DISPID_SGRSTNextState', 'SRTSMLTimeout',
           'DISPID_SLGetWords', 'DISPID_SPRText',
           'SpeechDisplayAttributes', 'SPAO_NONE',
           'eLEXTYPE_USER_SHORTCUT', 'SPRST_INACTIVE_WITH_PURGE',
           'DISPID_SpeechPhraseReplacement', 'SGSEnabled',
           'SpeechPropertyAdaptationOn', 'SAFTCCITT_uLaw_44kHzMono',
           'DISPID_SGRSAddWordTransition', 'ISpeechPhraseRules',
           'DISPID_SREmulateRecognition', 'Speech_Max_Word_Length',
           'SDKLCurrentUser', 'STSF_CommonAppData',
           'DISPID_SGRs_NewEnum', 'DISPID_SRGRecoContext',
           'DISPID_SDKSetLongValue', 'ISpLexicon',
           'DISPID_SLAddPronunciation', 'DISPID_SDKOpenKey',
           'DISPID_SRCEBookmark', 'DISPID_SpeechVoice',
           'ISpeechObjectToken', 'SpeechCategoryRecoProfiles',
           'SPEI_TTS_PRIVATE', 'DISPID_SPEDisplayText',
           'SpeechAudioState', 'SINoise', 'DISPID_SPRules_NewEnum',
           'SpWaveFormatEx', 'SRERecognition', 'SPEI_SR_PRIVATE',
           'eLEXTYPE_APP', 'DISPID_SVVoice', 'SRTExtendableParse',
           'DISPID_SMSAMMHandle', 'ISpRecoContext', 'DISPID_SRStatus',
           'ISpeechGrammarRule', 'DISPID_SpeechCustomStream',
           'DISPID_SDKGetStringValue', 'DISPID_SVAudioOutput',
           'DISPID_SAEventHandle', 'SP_VISEME_9', 'DISPIDSPTSI',
           'SGRSTTTextBuffer', 'SpMemoryStream', 'SP_VISEME_0',
           'SVSFParseAutodetect', 'DISPID_SASState',
           'SPSHORTCUTPAIRLIST', 'ISpeechAudioStatus',
           'SPSERIALIZEDPHRASE', 'ISpeechPhraseAlternates',
           'DISPID_SRGDictationUnload', 'SECFNoSpecialChars',
           'DISPID_SpeechMMSysAudio', 'SPWORDPRONOUNCEABLE',
           'DISPID_SPIAudioStreamPosition',
           'ISpeechTextSelectionInformation', 'SPBO_AHEAD',
           'DISPID_SDKCreateKey', 'SPEI_ADAPTATION', 'SVP_17',
           'SAFTADPCM_11kHzMono', 'DISPID_SLWsItem',
           'DISPID_SMSALineId', 'SGPronounciation', 'ISpPhrase',
           'SPPS_Modifier', 'SLTApp', 'DISPID_SPEDisplayAttributes',
           'DISPID_SRCVoicePurgeEvent', 'SPEI_SR_BOOKMARK',
           'SVEEndInputStream', 'SpeechTokenContext', 'SPCT_SLEEP',
           'SAFTCCITT_ALaw_22kHzStereo',
           'ISpeechLexiconPronunciation', 'DISPID_SPRsItem',
           'SPCS_DISABLED', 'DISPID_SPRs_NewEnum',
           'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SVRate',
           'SPEI_INTERFERENCE', 'eLEXTYPE_PRIVATE15',
           'SSSPTRelativeToEnd', 'SPEI_MIN_SR', 'SRSInactive',
           '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPWORDTYPE',
           'SAFT8kHz16BitStereo', 'SPCT_SUB_DICTATION',
           'ISpeechPhraseInfoBuilder', 'DISPID_SRGCmdSetRuleIdState',
           'SAFT32kHz8BitStereo', 'SVSFUnusedFlags',
           'SPEI_END_SR_STREAM', 'SPFM_OPEN_READONLY',
           'SRADefaultToActive', 'DISPID_SLPType',
           'DISPID_SpeechAudioBufferInfo', 'DISPID_SVSRunningState',
           'SAFT44kHz8BitStereo', 'DISPID_SVPriority',
           'DISPID_SRCBookmark', 'DISPID_SABIEventBias',
           'eLEXTYPE_PRIVATE8', 'SpVoice', 'SPEVENTENUM',
           'SPRECOCONTEXTSTATUS', 'IStream', 'SPRS_ACTIVE', 'SVP_19',
           'SpCustomStream', 'SVF_Emphasis', 'SVP_13',
           'DISPID_SVPause', 'SPEI_RECO_OTHER_CONTEXT',
           'DISPID_SGRsCount', 'DISPID_SGRsCommit', 'SGRSTTWildcard',
           'ISpeechWaveFormatEx', 'DISPID_SWFEAvgBytesPerSec',
           'DISPID_SRRTLength', 'ISpeechRecoResultDispatch',
           'DISPID_SpeechGrammarRuleStateTransitions',
           'SVSFPersistXML', 'SP_VISEME_16', 'SPRST_INACTIVE',
           'DISPID_SOTsItem', 'DISPID_SVSInputWordPosition',
           'DISPID_SRGSetTextSelection', 'SAFTCCITT_uLaw_11kHzMono',
           'SITooQuiet', 'DISPID_SRCEFalseRecognition',
           'eLEXTYPE_PRIVATE13', 'SAFT24kHz16BitStereo',
           'SAFTGSM610_44kHzMono', 'ISpGrammarBuilder', 'SVP_21',
           'SpeechAudioFormatGUIDWave', 'SpObjectToken',
           'SPXMLRESULTOPTIONS', 'SVEViseme', 'SAFTADPCM_8kHzMono',
           'SAFTGSM610_22kHzMono', 'SPEI_MAX_SR',
           'DISPID_SpeechFileStream', 'DISPID_SpeechLexicon',
           'SPPS_Verb', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
           'SVSFParseMask', 'SVEPrivate', 'SPCONTEXTSTATE',
           'DISPID_SOTCSetId', 'ISpeechXMLRecoResult',
           'SPWT_PRONUNCIATION', 'eLEXTYPE_PRIVATE4',
           'SAFT11kHz16BitStereo', 'ISpRecoGrammar', 'SGRSTTEpsilon',
           'SRCS_Disabled', 'DISPID_SPILanguageId', 'SWTDeleted',
           'SpUnCompressedLexicon', 'DISPID_SPPsItem',
           'ISpeechRecoContext', 'SPLEXICONTYPE',
           'DISPID_SDKSetStringValue', 'SVSFPurgeBeforeSpeak',
           'DISPID_SRCEPropertyStringChange',
           'ISpStreamFormatConverter', 'SAFTCCITT_ALaw_22kHzMono',
           'SPSVerb', 'DISPID_SLPs_NewEnum', 'ISpeechPhraseRule',
           'SP_VISEME_8', 'SRSActiveAlways', 'SPEI_RESERVED2',
           'DISPID_SPRuleName', 'DISPID_SRRAudio',
           'SAFT16kHz8BitStereo', 'SREInterference',
           'SAFT22kHz8BitStereo', 'DISPID_SRRecognizer', 'SINoSignal',
           'SpMMAudioEnum', 'DISPID_SVSLastStreamNumberQueued',
           'SAFT44kHz16BitMono', 'DISPID_SABIBufferSize',
           'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRGState',
           'DISPID_SpeechAudioFormat', 'SRESoundEnd',
           'SpTextSelectionInformation', 'SP_VISEME_11',
           'SPRST_ACTIVE', 'SRTStandard', 'SPBO_TIME_UNITS',
           'DISPID_SpeechRecoResult2', 'SSTTTextBuffer', 'SVP_12',
           'DISPID_SVEVoiceChange', 'SPRS_ACTIVE_USER_DELIMITED',
           'SPWT_DISPLAY', 'DISPID_SPRuleConfidence',
           'DISPID_SGRSTPropertyId', 'DISPID_SBSFormat',
           'IInternetSecurityManager', '_RemotableHandle',
           'SAFT44kHz8BitMono', 'SpeechGrammarWordType',
           'DISPID_SDKGetlongValue', 'SPVPRI_ALERT',
           'STCInprocServer', 'SAFT11kHz8BitStereo',
           'DISPID_SPEPronunciation', 'DISPID_SPRDisplayAttributes',
           'eLEXTYPE_RESERVED10', 'DISPID_SASCurrentSeekPosition',
           'SWPKnownWordPronounceable', 'SVP_11', 'DISPID_SRCResume',
           'SPEI_MAX_TTS', 'DISPID_SRSClsidEngine', 'DISPID_SPPValue',
           'DISPID_SpeechPhraseRules',
           'DISPID_SVSyncronousSpeakTimeout', 'SAFT12kHz8BitMono',
           'DISPID_SBSSeek', 'SpeechVisemeType', 'DISPID_SPRsCount',
           'DISPID_SpeechObjectTokenCategory', 'DISPID_SPAsItem',
           'DISPID_SpeechLexiconWord', 'SVSFIsXML',
           'DISPID_SRGCmdLoadFromResource', 'SpeechWordPronounceable',
           'SpeechTokenShellFolder', 'SAFTCCITT_uLaw_22kHzMono',
           'ISpPhoneticAlphabetSelection', 'SVEWordBoundary',
           'ISpeechGrammarRuleStateTransition', 'SPPHRASE',
           'DISPID_SVEStreamEnd', 'SPPS_RESERVED1',
           'SSFMOpenReadWrite', 'SPPARTOFSPEECH', 'SRSEIsSpeaking',
           'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPWORDLIST',
           'SECFIgnoreKanaType', 'DISPID_SRGReset', 'ISpeechAudio',
           'SSSPTRelativeToCurrentPosition', 'Speech_Max_Pron_Length',
           'SpeechLoadOption', 'ISpSerializeState', 'ISpeechDataKey',
           '_ISpeechVoiceEvents', 'DISPID_SPEActualConfidence',
           'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRIsUISupported',
           'DISPID_SPPParent', 'DISPID_SpeechObjectToken',
           'SpeechCategoryAudioIn', 'SpeechTokenKeyFiles',
           'SREStreamEnd', 'DISPID_SPPs_NewEnum',
           'SAFTADPCM_11kHzStereo', 'SAFT32kHz16BitMono',
           'SPEI_RESERVED3', 'SpeechGrammarRuleStateTransitionType',
           'ISpeechMMSysAudio', 'SPSNotOverriden',
           'SpeechCategoryVoices', 'SRCS_Enabled',
           'DISPID_SRCESoundStart', 'UINT_PTR', 'SPEI_PHONEME',
           'SpeechDictationTopicSpelling', 'DISPID_SAFGuid',
           'SPEI_RECOGNITION', 'SPRULE', 'ISpeechRecoResultTimes',
           'DISPID_SPARecoResult', 'DISPID_SPIAudioSizeTime',
           'DISPID_SPRuleFirstElement', 'SVSFIsFilename',
           'DISPID_SPRuleNumberOfElements', 'DISPID_SRState',
           'ISpeechVoice', 'DISPID_SpeechGrammarRuleState',
           'DISPIDSPRG', 'DISPID_SPRuleChildren', 'SAFT16kHz8BitMono',
           'DISPID_SRCEInterference', 'LONG_PTR',
           'SPINTERFERENCE_NOISE', 'SPEI_FALSE_RECOGNITION',
           'DISPID_SPIGetText', 'SpeechRuleState',
           'DISPID_SRSNumberOfActiveRules',
           'DISPID_SAFGetWaveFormatEx', 'DISPID_SABufferInfo',
           'SP_VISEME_5', 'SPWF_SRENGINE', 'SAFT48kHz16BitMono',
           'DISPID_SRCEEndStream', 'DISPID_SRRTOffsetFromStart',
           'DISPID_SGRSTsCount', 'SVSFVoiceMask', 'SDKLLocalMachine',
           'DISPID_SRRTTickCount', 'SPEI_SENTENCE_BOUNDARY',
           'SDTProperty', 'SpeechPropertyLowConfidenceThreshold',
           'SVEBookmark', 'DISPID_SWFEChannels', 'DISPID_SLPsCount',
           'DISPID_SRRRecoContext', 'DISPID_SRSetPropertyString',
           'SpeechEmulationCompareFlags', 'SPAR_Medium',
           'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRRTimes',
           'DISPID_SLPsItem', 'SPPS_Interjection',
           'SDA_Two_Trailing_Spaces', 'ISpeechResourceLoader',
           'SSSPTRelativeToStart', 'SPEI_SR_AUDIO_LEVEL',
           'SAFTCCITT_uLaw_8kHzMono', 'SpeechGrammarTagDictation',
           'DISPID_SGRInitialState', 'SECNormalConfidence',
           'SpPhoneticAlphabetConverter', 'eLEXTYPE_PRIVATE16',
           'DISPID_SGRSTPropertyValue', 'SP_VISEME_21',
           'SpeechStreamSeekPositionType', 'SPRST_ACTIVE_ALWAYS',
           'SPCT_DICTATION', 'SRADynamic', 'DISPID_SRGRules',
           'DISPID_SpeechXMLRecoResult', 'SpInprocRecognizer',
           'SVF_None', 'SREStateChange', 'SPWAVEFORMATTYPE',
           'DISPID_SOTCDefault', 'DISPID_SGRAddResource',
           'DISPID_SPERetainedStreamOffset', 'SPPHRASEPROPERTY',
           'SPCATEGORYTYPE', 'SDA_No_Trailing_Space', 'SPVPRI_OVER',
           'SPPS_Noun', 'SAFTDefault', 'SSTTWildcard',
           'DISPID_SRCCreateGrammar', 'DISPID_SRCEStartStream',
           'SpeechEngineConfidence', 'DISPID_SPEAudioTimeOffset',
           'SpeechRecoEvents', 'SRAImport', 'SPRECOSTATE', 'SVP_3',
           'DISPID_SGRSTransitions', 'SAFT8kHz8BitMono',
           'SPDKL_CurrentUser', 'eLEXTYPE_RESERVED7',
           'STSF_FlagCreate', 'DISPID_SGRSRule', 'ISpShortcut',
           'SREAudioLevel', 'SPPS_RESERVED3', 'SDTRule',
           'SAFTADPCM_22kHzStereo', 'SRSActive',
           'DISPID_SRAudioInput', 'STCAll', 'SPDATAKEYLOCATION',
           'eLEXTYPE_USER', 'DISPID_SAVolume', 'SAFT24kHz8BitStereo',
           'SPEI_PROPERTY_NUM_CHANGE', 'ISpRecognizer2',
           'SpeechAudioProperties', 'SpeechMicTraining',
           'DISPID_SRRSetTextFeedback', 'SITooFast',
           'SPWORDPRONUNCIATION', 'DISPID_SVSLastBookmarkId',
           'ISpRecognizer', 'SpInProcRecoContext', 'SpeechTokenKeyUI',
           'DISPID_SpeechPhraseElements', 'SP_VISEME_19',
           'DISPID_SOTDisplayUI', '_ISpeechRecoContextEvents']
